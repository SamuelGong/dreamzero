...
If you are *not* using the company's internal network, simply follow the instructions on original [README](./README.md).
...
MAX_JOBS=8 pip install --no-build-isolation flash-attn  # 8 here can be something larger
```
